...
class Century21(Spider):

    name = 'c21.ca'
    allowed_domains = ['www.c21.ca']

    start_urls = ['https://www.c21.ca/directory/offices/bamber-realty-ltd']
    custom_settings = {
        'ITEM_PIPELINES': {
    ...
    def parse_profile(self, response):
        ...
        agent['brand'] = response.css(
            'address.agent-office > a > span::text').get()
